...
namespace simPROJECT.FS
{
    class FSUIPC
    {
        ...
        public static FSUIPC FS = new FSUIPC();

        private static DateTime _lastConnectingTryingTime = DateTime.MinValue;
        private static TimeSpan __intervalBetweenConnecting = new TimeSpan(0, 0, 10);

        private static int __errorsCounter = 0;
		...
		private void FSUIPC_Initialization() 
		{
		...
		private bool FSUIPC_Open(int dwFSReq, ref int dwResult) 
		{
		...
		///<param name="dwResult">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Read(int dwOffset, int dwSize, ref int Token, ref int dwResult) 
		{
		...
		///<param name="dwResult">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Process(ref int dwResult) 
		{
		...
		///<param name="dwResult">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Write(int dwOffset, byte param, ref int Token, ref int dwResult) 
		{
		...
		///<param name="dwResult">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Write(int dwOffset, short param, ref int Token, ref int dwResult) 
		{
		...
		///<param name="dwResult">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Write(int dwOffset, int param, ref int Token, ref int dwResult) 
		{
		...
		///<param name="dwResult">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Write(int dwOffset, long param, ref int Token, ref int dwResult) 
		{
		...
		///<param name="dwResult">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Write(int dwOffset, int dwSize, ref byte[] param, ref int Token, ref int dwResult) 
		{
		...
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Get(ref int Token, ref byte Result) 
		{
			int Size = 1;    // 1 byte
		...
		///<param name="result">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Get(ref int Token, ref short Result) 
		{
		...
		///<param name="result">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Get(ref int Token, ref int Result) 
		{
		...
		///<param name="result">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Get(ref int Token, ref long Result) 
		{
		...
		///<param name="result">Contains the "error-code" if method's boolean comes back false</param>
		///<return>true if successful, false otherwise.  If false, dwResult contains the "error-code"</return>
		private bool FSUIPC_Get(ref int Token, int dwSize, ref byte[] Result) 
		{
